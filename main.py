# TODO 
# # 1) Как еще можно остановить все потоки? Если код большой, будет супер неудобно постоянно делать проверку.
# 2) Семафор нужен? В задании написано все потоки должны выполняться одновременно, но их может быть и 100...
